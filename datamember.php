    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item">Fooking</li>
...
if (isset($_POST['submit'])) {
    ...
    $alamat = $_POST['alamat'];
    $user = $_POST['user'];
    $pass = md5($_POST['pass']); // Gunakan hashing password

    $mysql = "INSERT INTO tb_member (nik, nama, jk, telp, alamat, user, pass) VALUES ('$nik', '$nama', '$jk', '$telp', '$alamat', '$user', '$pass')";
    
    if (mysqli_query($koneksi, $mysql)) {
        echo '<script>alert("Data berhasil direkam"); location.href="rental.php?nik=' . $nik . '";</script>';
    } else {
...
?>
  ...
  <footer id="footer" class="footer">
    <div class="copyright">
     <strong><span>Form Booking Member</span></strong>
